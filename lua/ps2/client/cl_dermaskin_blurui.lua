...
local function DrawBlur(panel, amount, layers, color)
...
SKIN.HeaderBG   = Color(52, 152, 219, 150)
SKIN.MainBG     = Color( 56, 60, 66, 200 )
SKIN.InnerPanel = Color( 49, 49, 49, 150 )
SKIN.Footer = Color( 59, 59, 59, 200)
SKIN.ButtonColor = Color( 65, 65, 65 )
SKIN.BrightPanel = Color( 102, 102, 102 )
SKIN.Highlight	= Color( 89, 179, 0 )
...
surface.CreateFont( "PS2_LargeHeading_Gidole", {
	font = "Gidole",
	size = 46,
} )

surface.CreateFont( "PS2_MediumLarge_Gidole", {
	font = "Gidole",
	size = 28,
} )

surface.CreateFont( "PS2_SmallHeading_Gidole", {
	font = "Gidole",
	size = 24,
} )

surface.CreateFont( "PS2_Normal_Gidole", {
	font = "Gidole",
	size = 20,
} )

surface.CreateFont( "PS2_Text_Gidole", {
	font = "Gidole",
	size = 14,
} )

SKIN.fontName = "PS2_Normal_Gidole"
SKIN.BigTitleFont = "PS2_LargeHeading_Gidole"
SKIN.SmallTitleFont = "PS2_SmallHeading_Gidole"
SKIN.TabFont = "PS2_MediumLarge_Gidole"
SKIN.ButtonFont = "PS2_MediumLarge_Gidole"
SKIN.TextFont = "PS2_Text_Gidole"
...
derma.DefineSkin( SKIN.Name, "Poinsthop2 Blur", SKIN )

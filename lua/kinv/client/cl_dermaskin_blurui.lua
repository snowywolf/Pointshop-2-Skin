local SKIN = {}
SKIN.Name = "KInventoryBasic_BlurUI"

local function loadSkin( )

SKIN.HighlightColor = Color( 89, 179, 0 )
SKIN.BaseColor = Color( 255, 255, 255 )

surface.CreateFont( "KInventoryDefaultFont_Gidole", {
 font = "Gidole",
 size = 74,
 weight = 9,
 blursize = 0,
...
SKIN.MainFont = "KInventoryDefaultFont_Gidole"
